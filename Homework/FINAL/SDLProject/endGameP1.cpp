...
BACKGROUND_FILEPATH[] = "assets/p1win.png";

GLuint g_font_texture_id_P1;
GLuint background_texture_id_P1;

unsigned int LEVEL_DATA_P1[] =
{
...
void endGameP1::initialise()
{
    GLuint map_texture_id = Utility::load_texture("assets/DesertMod10.png");
    g_font_texture_id_P1 = Utility::load_texture(FONT_FILEPATH);
    background_texture_id_P1 = Utility::load_texture(BACKGROUND_FILEPATH);
    m_game_state.background_map = new Entity(background_texture_id_P1, 0.0f, 40.0f, 22.5f, BACKGROUND);
    m_game_state.background_map->set_position(glm::vec3(0.0f, 0.0f, 0.0f));
    
    m_game_state.player = nullptr;
    m_game_state.player2 = nullptr;
    m_game_state.map = m_game_state.map = new Map(LEVEL_WIDTH, LEVEL_HEIGHT, LEVEL_DATA_P1, map_texture_id, 1.0f, 5, 4);
...
void endGameP1::update(float delta_time)
{
    m_game_state.background_map->update(delta_time, nullptr, nullptr, 0, m_game_state.map);
}


void endGameP1::render(ShaderProgram *g_shader_program)
{
...
void endGameP1::shoot_projectile(Entity* shooter)
{
