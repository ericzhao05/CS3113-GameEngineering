...
void initialise()
{
    ...
    g_projection_matrix = glm::ortho(-5.0f * 1.5f, // zomm out
                                     5.0f * 1.5f, // zomm out
                                     -3.75f, 3.75f,
                                     -1.0f, 1.0f);
...
//        g_game_state.player->update(FIXED_TIMESTEP, g_game_state.player, g_game_state.platforms, PLATFORM_COUNT);
        g_game_state.player->update(FIXED_TIMESTEP, g_game_state.player, nullptr, PLATFORM_COUNT);
...
//                                           PLATFORM_COUNT);
    ...
    g_view_matrix = glm::translate(g_view_matrix,
                                   glm::vec3(-g_game_state.player->get_position().x, 0.0f, 0.0f));
}
